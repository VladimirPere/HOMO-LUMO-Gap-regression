...
xgb_model = desc_XGB_search.best_estimator_.named_steps['regressor']
...
# shap values
RF_preprocessor = desc_RF_search.best_estimator_.named_steps['scaler']
d_train_scaled_RF = RF_preprocessor.transform(d_train)
rf_model = desc_RF_search.best_estimator_.named_steps['regressor']
