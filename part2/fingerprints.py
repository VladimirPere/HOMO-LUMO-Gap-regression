...
# fingerprints.py output: qm9_fingerprints_p2.csv [smiles, bit_0, bit_1, ... gap]
...
# final QA
print(fp_df.shape)  # (21981, 2050) — 2048 bits + smiles + gap
print(fp_df.head())

fp_df.to_csv(CSV_DIR/'qm9_fingerprints_p2(2048).csv', index=False)